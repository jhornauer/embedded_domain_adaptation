"""
Source: https://github.com/dwofk/fast-depth/blob/master/dataloaders/nyu.py
"""

import numpy as np
import data.transforms as transforms
from data.dataloader_nyu import MyDataloader
...
class NYUDataset(MyDataloader):
    def __init__(self, root, split, src_file=None, modality='rgb'):
        self.split = split
        super(NYUDataset, self).__init__(root, split, src_file, modality)
